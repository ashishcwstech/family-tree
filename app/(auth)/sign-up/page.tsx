...
export const signUpSchema = z.object({
  ...
  confirmPassword: z.string().min(4, "Confirm password must be at least 4 chars"),
});
      ...
      <main className="relative z-10 w-full max-w-md sm:max-w-lg md:max-w-xl">
        ...
        <div className="glass-panel rounded-xl p-5 sm:p-6 md:p-8 shadow-lg ghost-border">
          ...
          >
            ...
            <button
              className="w-full h-12 sm:h-14 primary text-on-primary font-bold rounded-lg flex items-center justify-center gap-2 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <button className="h-11 sm:h-12 rounded-lg bg-surface-container-lowest hover:bg-surface-container-low flex items-center justify-center gap-2 text-sm font-semibold">
              <img className="w-4 h-4 sm:w-5 sm:h-5" src="/google-logo.png" />
              Google
            </button>

            <button className="h-11 sm:h-12 rounded-lg bg-surface-container-lowest hover:bg-surface-container-low flex items-center justify-center gap-2 text-sm font-semibold">
              <img className="w-4 h-4 sm:w-5 sm:h-5" src="/icloud.png" />
              iCloud
            </button>
          </div>
        </div>
